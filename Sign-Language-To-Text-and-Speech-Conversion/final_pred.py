...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:\\Users\\karan\\OneDrive\\Documents\\majorproject\\Sign-Language-To-Text-and-Speech-Conversion\\cnn8grps_rad1_model.h5')
        ...
        self.clear.config(text="Speak", font=("Courier", 20), wraplength=100, command=self.speak_fun)
