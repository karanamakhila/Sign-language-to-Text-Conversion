...
count = len(oss.listdir("C:\\Users\\karan\\OneDrive\\Documents\\majorproject\\Sign-Language-To-Text-and-Speech-Conversion\\AtoZ_3.1\\A"))
c_dir = 'A'
...
cv2.imwrite("C:\\Users\\karan\\OneDrive\\Documents\\majorproject\\Sign-Language-To-Text-and-Speech-Conversion\\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread("C:\\Users\\karan\\OneDrive\\Documents\\majorproject\\Sign-Language-To-Text-and-Speech-Conversion\\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:\\Users\\karan\\OneDrive\\Documents\\majorproject\\Sign-Language-To-Text-and-Speech-Conversion\AtoZ_3.1" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:\Users\karan\OneDrive\Documents\majorproject\Sign-Language-To-Text-and-Speech-Conversion\AtoZ_3.1" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
